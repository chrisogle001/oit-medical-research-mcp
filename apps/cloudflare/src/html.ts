...
export function renderHome(origin: string): Response {
  return htmlResponse(
    page(
    ...
    page(
      ...
      `<main class="shell account-shell">
        ...
        <section class="grid sources">
          <article class="card"><span class="status ready">Ready</span><h2>PubMed &amp; PMC</h2><p>Available without personal credentials. An NCBI API key can be added in a later settings milestone for higher request limits.</p></article>
...
const styles = `
  ...
  *{box-sizing:border-box} body{margin:0;background:radial-gradient(circle at top left,#e4f2e9 0,transparent 38rem),var(--paper);color:var(--ink);font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;line-height:1.55} a{color:inherit} code{font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:.88em;overflow-wrap:anywhere}
  ...
  .account-shell{padding-top:1.5rem}.account-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem}.brand{font-weight:800;text-decoration:none}.text-button{border:0;background:transparent;color:var(--green);font:inherit;font-weight:750;cursor:pointer;padding:.4rem}.profile{display:flex;align-items:center;gap:1.25rem;padding:2rem}.profile img,.avatar-fallback{border-radius:50%;background:var(--mint)}.avatar-fallback{width:64px;height:64px;display:grid;place-items:center;font-size:1.5rem;font-weight:800}.profile h1{font-size:2.25rem;margin:.35rem 0 .1rem}.profile p{margin:0;color:var(--muted)}.settings{padding:2rem;margin-top:1rem}.section-heading{display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid var(--line);padding-bottom:1rem}.count{display:grid;place-items:center;border-radius:999px;background:var(--mint);color:var(--green);width:2rem;height:2rem;font-weight:800}.grant{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1.1rem 0;border-bottom:1px solid var(--line)}.grant:last-child{border-bottom:0}.grant h3,.grant p{margin:.15rem 0}.grant p{color:var(--muted);font-size:.9rem}.empty{padding:2.5rem 0;text-align:center;color:var(--muted)}.empty h3{color:var(--ink)}.status{display:inline-block;border-radius:999px;padding:.2rem .55rem;font-size:.72rem;font-weight:800}.status.ready{background:var(--mint);color:var(--green)}.notice{background:var(--mint);border:1px solid #b9dec9;color:var(--green-dark);padding:.8rem 1rem;border-radius:12px;margin-bottom:1rem}
